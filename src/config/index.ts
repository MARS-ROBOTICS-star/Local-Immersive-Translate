...
export const DEFAULT_TRANSLATE_MODEL = "kimi";
...
export function normalizeTranslateModel(model: string) {
  return translateModels.some((m) => m.value === model)
    ? model
